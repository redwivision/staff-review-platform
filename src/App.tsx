                ...
                <button
                  ...
                  onClick={() => {
                    if (isAdmin) {
                      ...
                      void runExportEvaluationToPDF(activeTLEvaluation.member, activeTLEvaluation.quarter, activeTLEvaluation.summary, { isDefaultOnly: true }).catch(err => console.error("PDF export failed:", err));
                    }
                  }}
                ...
                onClick={async () => {
                  ...
                  try {
                    if (pdfExportConfig.isBulk && pdfExportConfig.bulkItems) {
                      ...
                      await runExportEvaluationToPDF(
